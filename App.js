    ...
    <NavigationContainer>
      <Stack.Navigator initialRouteName="Home">
        <Stack.Screen
          ...
          options={{ title: 'App Tabuadas' }}
        />
        <Stack.Screen
          name="TabuadaDo2"
          component={TabuadaDo2}
          options={{ title: 'Tabuada do 2' }}
        />
        <Stack.Screen
          name="TabuadaDo3"
          component={TabuadaDo3}
          options={{ title: 'Tabuada do 3' }}
        />
        <Stack.Screen
          name="TabuadaDo4"
          component={TabuadaDo4}
          options={{ title: 'Tabuada do 4' }}
        />
        <Stack.Screen
          name="TabuadaDo5"
          component={TabuadaDo5}
          options={{ title: 'Tabuada do 5' }}
        />
        <Stack.Screen
          name="TabuadaDo6"
          component={TabuadaDo6}
          options={{ title: 'Tabuada do 6' }}
        />
        <Stack.Screen
          name="TabuadaDo7"
          component={TabuadaDo7}
          options={{ title: 'Tabuada do 7' }}
        />
        <Stack.Screen
          name="TabuadaDo8"
          component={TabuadaDo8}
          options={{ title: 'Tabuada do 8' }}
        />
        <Stack.Screen
          name="TabuadaDo9"
          component={TabuadaDo9}
          options={{ title: 'Tabuada do 9' }}
        />
        <Stack.Screen
          name="TabuadaDo10"
          component={TabuadaDo10}
          options={{ title: 'Tabuada do 10' }}
        />
      </Stack.Navigator>
    </NavigationContainer>
  );
